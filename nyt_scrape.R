...
setwd("/Users/tammystugan/Documents/GitHub/TAD_2021/TAD_2021/TAD_2021/TAD_2021/TAD_2021/TAD_2021/TAD_2021/TAD_2021")
...
comb <- rbind(facebook_2021_articles$response.docs.lead_paragraph, facebook_2020_articles$response.docs.lead_paragraph)
par <- dfm(comb)
...
textstat_readability(facebook_2021_articles$response.docs.lead_paragraph)
textstat_readability(facebook_2020_articles$response.docs.lead_paragraph)
